...
import icon1 from "../../assets/stat/icons/icon1.svg";
        ...
        <div className="bg-[#0c0c0c]  h-[750px] p-7  rounded-b-2xl grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-4 gap-y-4">
          <div className="flex flex-col gap-7 ">
            ...
            <div className="flex items-center justify-between w-[1100px]">
              ...
              <span className="text-[#B5B9BD] font-thin text-xl">Agent</span>
              <span className="text-[#B5B9BD] font-thin text-xl">KD</span>
              <span className="text-[#B5B9BD] font-thin text-xl">KDA</span>
              <span className="text-[#B5B9BD] font-thin text-xl ">Win %</span>
              <span className="text-[#B5B9BD] font-thin text-xl">Pick %</span>
            ...
            <div className="flex items-center justify-between w-[1100px]">
              ...
              <span className="text-white font text-xl mr-14">07%</span>
              <span className="text-white font text-xl mr-20">206</span>
              <span className="text-[#95D97D] font text-xl mr-16">0.1%</span>
