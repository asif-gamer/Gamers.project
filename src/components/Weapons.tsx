  ...
  return (
    <div className="w-[1400px] h-fit">
      ...
      <div className="flex flex-col items-center ">
        <h1 className="text-[14px] text-white mb-2.5">
          Select Sidearms
        </h1>
        ...
        <div className="flex flex-col gap-1 items-center">
          <div className="bg-[#1A1C20] w-[48px] h-[48px] rounded-full">
            <img
              src={gun4}
              alt="logo"
              className="w-[39px] h-[34px] object-contain top-0 bottom-0 left-0 right-0 m-auto mt-2"
            />
          </div>
          <p className="text-[#B5B9BD] text-[14px] mb-4">Ghost</p>
        </div>
        <div className="flex flex-col gap-1 items-center">
          <div className="bg-[#1A1C20] w-[48px] h-[48px] border-4   rounded-full   object-contain  border-blue-400  shadow-glow">
            <img
              src={gun5}
              alt="logo"
              className="w-[34px] h-[31px] object-contain top-0 bottom-0 left-0 right-0 m-auto mt-1.5 "
            />
          </div>
          <p className="text-white font-semibold text-[14px]">Sheriff</p>
        </div>
      </div>
      <div className="max-w-[1000px] w-full">
        ...
        <div className="flex flex-col gap-3 p-7  bg-[#1A1C1F] h-[164px] rounded-t-2xl">
          ...
          <div className="flex items-start gap-[32px] mt-4">
            ...
            <Link to="/snipers">
              <p className="text-[14px] text-[#7D8185]">Snipers</p>
            </Link>
            <Link to="/heavy">
          ...
          <div className="flex">
            ...
            <div className="flex flex-col p-2">
              <div className="bg-[#1A1C1F] w-[300px] h-[149px] rounded-3xl flex flex-col border-2 border-blue-400  z-30 ">
                ...
                />
                <p className="text-white text-[14px] text-center mb-4">Classic</p>
              </div>
                ...
                <div className="flex flex-col gap-1.5 mt-8">
                  <div className="flex flex-col  px-6  text-2xl">
                    ...
                    <div className="flex justify-between">
                      ...
                      <p className="text-white text-[14px] font-semibold">150</p>
                    </div>
                  </div>
                  <div className="flex flex-col px-6 text-2xl">
                    ...
                    <div className="flex justify-between">
                      <p className="text-[#7D8185] text-[14px]">Rate of Fire</p>
                      <p className="text-white text-[14px] font-semibold">
                        6.76<span className="text-[#7D8185] text-[14px]">Rounds/Sec</span>
                      </p>
                    </div>
                  </div>
                  <div className="flex flex-col  px-6  text-2xl">
                    ...
                    <div className="flex justify-between ">
                      <p className="text-[#7D8185] text-[14px] w-1/2">Fire Mode</p>
                    ...
                    <div className="flex justify-between">
                      <p className="text-[#7D8185] text-[14px]">Rate of Fire</p>
                      <p className="text-white text-[14px] font-semibold">
                        2.22<span className="text-[#7D8185] text-[14px]">Rounds/Sec</span>
                      </p>
                    </div>
                  </div>
                  <div className="flex flex-col px-6 text-2xl">
                    ...
                    <div className="flex justify-between">
                      <p className="text-[#7D8185] text-[14px]">Magazine Capacity</p>
                      <p className="text-white text-[14px] font-semibold">12</p>
                    </div>
                    <div className="flex justify-between">
                      <p className="text-[#7D8185] text-[14px]">Wall Penetration</p>
                      <p className="text-white text-[14px] font-semibold">Low</p>
                    </div>
                    <div className="flex justify-between">
                      <p className="text-[#7D8185] text-[14px]">Reload Speed</p>
                      <p className="text-white text-[14px] font-semibold">Low</p>
                    </div>
                    <div className="flex justify-between">
                      <p className="text-[#7D8185] text-[14px]">Drop off Distance</p>
                      <p className="text-white text-[14px] font-semibold">Low</p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex flex-col justify-between">
                    ...
                    <div className="flex">
                      ...
                      <div className="flex flex-col justify-between">
                        ...
                        <p className="text-[#266AC6] text-[12px] mb-3"> - 32</p>
                        <p className="text-[#B5B9BD] text-[12px] mb-2.5"> - 23</p>
                      </div>
                    </div>
                  </div>
                  <div className="flex flex-col justify-between ">
